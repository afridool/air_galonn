            ...
            <div class="col-sm-4">
                <div class="container" style="background-color: whitesmoke;">
                    ...
                    <div class="list-group">
                        ...
                        <a href="transaksi-proses.php" class="list-group-item list-group-item-action active"><i class="bi bi-arrow-repeat"></i> Sedang di Proses</a>
            ...
            <div class="col-sm-8">
                <div class="container" style="background-color: whitesmoke;">
                    ...
                    <?php 
                        ...
                        WHERE user.id_user = :id_user AND pesanan_galon.status_pesanan = 'Sedang Diproses'
                        ");
