...
// Buat prepared statement untuk mengambil semua data dari tbBiodata
    ...
    WHERE pesanan_galon.status_pesanan = 'Dikirim'
    ");
            ...
            <div class="col-sm-4">
                <div class="container" style="background-color: whitesmoke;">
                    ...
                    <div class="list-group">
                        <a href="transaksi.php" class="list-group-item list-group-item-action"><i class="bi bi-three-dots"></i> Semuanya</a>
                        <a href="transaksi-proses.php" class="list-group-item list-group-item-action"><i class="bi bi-arrow-repeat"></i> Sedang di Proses</a>
                        <a href="transaksi-dikirim.php" class="list-group-item list-group-item-action active"><i class="bi bi-truck"></i> Dikirim</a>
            ...
            <div class="col-sm-8">
                <div class="container" style="background-color: whitesmoke;">
                    ...
                    <?php 
                        ...
                        WHERE user.id_user = :id_user AND pesanan_galon.status_pesanan = 'Dikirim'
                        ");
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary"><i class="sbi bi-check2"></i> Ya</button>
                </div>
            </div>
        </div>
    </div>
