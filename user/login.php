...
<main class="form-signin">
  <form action = "proses/proses-login.php" method="post">
    ...
    <p>Belum punya akun ? <a href="daftar-akun.php" style="text-decoration: none;">Daftar</a> Sekarang</p>
    <p>Login Penjual Galon ? <a href="../pemilik-depot/login-penjual.php" target="_blank" style="text-decoration: none;">Klik Disini</a>
