            ...
            <div class="col-sm-4">
                <div class="container" style="background-color: whitesmoke;">
                    ...
                    <div class="list-group">
                        ...
                        <a href="transaksi-selesai.php" class="list-group-item list-group-item-action active"><i class="bi bi-check-square-fill"></i> Selesai</a>
                    </div><br>
                </div><br>
            </div>
            <!--end menu transaksi-->
            ...
            <div class="col-sm-8">
                <div class="container" style="background-color: whitesmoke;">
                    ...
                    <?php 
                          ...
                          WHERE user.id_user = :id_user AND pesanan_galon.status_pesanan = 'Selesai'
                          ");
