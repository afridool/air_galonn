  ...
  <body>
    ...
    <div class="container" style="background-color: whitesmoke;">
        <div class="container-fluid">
            <h4>Peta Depot Air Galon</h4>
            <hr>
                <iframe src="https://www.google.com/maps/d/embed?mid=10gze4lKuluBsgG8uvBA_4cZdy-YSUeGg" width="1100" height="450"></iframe>
        </div><br>
    </div><br><br>
    <!--End Peta-->
    <div class="container" style="background-color: whitesmoke;">
        <h4>Rekomendasi</h4><hr>
        <div class="row row-cols-1 row-cols-md-3 g-4">
        <?php 
						  // Buat prepared statement untuk mengambil semua data dari tbBiodata
						$query = $connect->prepare("SELECT * FROM depot_galon ORDER BY nama_depot desc limit 4");
						// Jalankan perintah SQL
						$query->execute();
						// Ambil semua data dan masukkan ke variable $data
							$data = $query->fetchAll();
