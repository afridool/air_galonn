...
if (empty($_SESSION['username'])){
 ...
 if(isset($_POST['submit'])){
        ...
        // Jalankan perintah SQL
		 if( $query->execute())
		{
		 echo "<script>alert('Input Berhasil !',document.location.href='../kelola depot.php')</script>";
		}
		else
		{
		 echo "<script>alert('Input gagal !',document.location.href='beranda.php')</script>";
		}
