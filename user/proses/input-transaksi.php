<?php
 ...
 if(isset($_POST['submit'])){
        ...
        $query = $connect->prepare("INSERT INTO pesanan_galon(jumlah_isi_ulang, jumlah_galon_baru, total_pembayaran, metode_pembayaran, status_pesanan, id_galon, id_user)
        VALUES (:jumlah_isi_ulang,:jumlah_galon_baru,:total_pembayaran,:metode_pembayaran, :status_pesanan, :id_galon, :id_user)");
        ...
        // Jalankan perintah SQL
		 if( $query->execute())
		{
		 echo "<script>alert('Pesanan Berhasil !',document.location.href='../transaksi.php')</script>";
		}
		else
		{
		 echo "<script>alert('Pesanan Gagal !',document.location.href='../checkout.php')</script>";
		}
