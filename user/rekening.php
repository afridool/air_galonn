  ...
  <body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-3">
                <div class="container" style="background-color: whitesmoke;">
                    ...
                    <div class="list-group">
                        ...
                        <a href="rekening.php" class="list-group-item list-group-item-action active"><i class="bi bi-bank2"></i> Rekening</a>
            ...
            <div class="col-sm-9">
                <div class="container" style="background-color: whitesmoke;">
                    <form action="proses/update-rekening.php?id=<?php echo $data['id_user']?>" method="post">
                    <h4>Rekening</h4><hr>
                    <table class="table table-borderless" style="width: 600px;">
                        <tbody>
                            <tr>
                                <td>Nama Nasabah</td>
                                <td><input type="text" placeholder="Nama (Harus Sama Dengan di Rekening Bank)" value="<?php echo $data['nama_rekening']?>" name ="nama_rekening" style="width: 400px;"></td>
                            </tr>
                            <tr>
                                <td>No. Rekening</td>
                                <td><input type="text" placeholder="No Rekening" value="<?php echo $data['no_rekening']?>" name ="no_rekening" style="width: 400px;"></td>
                            </tr>
                            <tr>
                                <td>Bank</td>
                                <td><select name="nama_bank" class="form-select" id="" style="width:200px;" required>
                                    <option value="<?php echo $data['nama_bank']?>" selected hidden><?php echo $data['nama_bank']?></option>
