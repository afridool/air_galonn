  ...
  <div class="w3-row-padding w3-margin-bottom">
    <div class="w3-container">
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="pesanan-selesai.php" style="color:black;">Selesai</a>
            </li>
        </ul><br>
        <div class="col-sm-10">
        <div class="container" style="background-color: whitesmoke;">
            ...
            WHERE depot_galon.id_galon = :id_galon AND pesanan_galon.status_pesanan = 'Selesai'
                        ");
						// Jalankan perintah SQL
