  ...
  <div class="w3-row-padding w3-margin-bottom">
    <div class="w3-container">
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" aria-current="page" href="pesanan-proses.php" style="color:black;">Sedang Diproses</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="pesanan-dikirim.php" style="color:black;">Dikirim</a>
            </li>
            <li class="nav-item">
        ...
        <div class="container" style="background-color: whitesmoke;">
            ...
            WHERE depot_galon.id_galon = :id_galon AND pesanan_galon.status_pesanan = 'Sedang Diproses'
                        ");
						// Jalankan perintah SQL
