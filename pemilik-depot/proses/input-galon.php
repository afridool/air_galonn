<?php
 ...
 if(isset($_POST['submit'])){
        ...
        $query = $connect->prepare("INSERT INTO depot_galon(nama_galon, nama_depot, harga_isi_ulang, harga_galon_baru, lokasi_depot, no_hp, id_galon, alamat_depot, latitude, longitude, gambar_depot, pemilik, username, password)
        VALUES (:nama_galon,:nama_depot,:harga_isi_ulang,:harga_galon_baru,:lokasi_depot,:no_hp,:id_galon,:alamat_depot,:latitude,:longitude,:gambar_depot,:pemilik, :username, :password)");
        ...
        $query->bindParam(":alamat_depot", $alamat);
        ...
        // Jalankan perintah SQL
		 if( $query->execute())
		{
		 echo "<script>alert('Input Berhasil !',document.location.href='../daftar-depot.php')</script>";
		}
		else
		{
		 echo "<script>alert('Input gagal !',document.location.href='../daftar-depot.php')</script>";
		}
