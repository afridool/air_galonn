...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="bi bi-building"></i> Profil</b></h5>
    <hr>
  </header>
  ...
  <div class="w3-row-padding w3-margin-bottom">
    <div class="w3-container">
        ...
        <div class="row">
            ...
            <form action="proses/update-data-galon.php?id=<?php echo $data['id_galon'] ?>" method="post" enctype="multipart/form-data">
                <table class="table table-borderless" style="width: 500px;">
                    <tbody>
                        <tr>
                            <td>Nama Depot</td>
                            <td><input type="text" name = "nama_depot" placeholder="Nama Depot" value="<?php echo $data['nama_depot']?>" style="width: 200px;"></td>
                        </tr>
                        <tr>
                            <td>Nama Galon</td>
                            <td><input type="text" name = "nama_galon" placeholder="Nama Galon" value="<?php echo $data['nama_galon']?>" style="width: 200px;"></td>
                        </tr>
                        <tr>
                            <td>Harga Isi Ulang</td>
                            <td><input type="text" name = "harga_isi_ulang" placeholder="Harga Isi Ulang" value="<?php echo $data['harga_isi_ulang']?>" style="width: 200px;"></a></td>
                        </tr>
                        <tr>
                            <td>Harga Galon Baru</td>
                            <td><input type="text" name = "harga_galon_baru" placeholder="Harga Galon Baru" value="<?php echo $data['harga_galon_baru']?>" style="width: 200px;"></a></td>
                        </tr>
                        <tr>
                            <td>No. HP</td>
                            <td><input type="text" name = "no_hp" placeholder="Nomor HP" value="<?php echo $data['no_hp']?>" style="width: 200px;"></a></td>
                        </tr>
                        <tr>
                            <td>Pemilik</td>
                            <td><input type="text" name = "pemilik" placeholder="Pemilik" value="<?php echo $data['pemilik']?>" style="width: 200px;"></a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="col-sm-4">
                <div class="container">
                    <img src="gambar/<?php echo $data['gambar_depot']?>" class="w3-circle w3-margin-right" style="width:115px; height: 115px;">
                </div><br>
                <input type="file" name="gambar_depot" value="Upload Foto" placeholder="Pilih Foto">
            </div>
        </div>
        <div class="container">
