...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="bi bi-card-checklist"></i> Data Pesanan</b></h5>
    <hr>
  </header>
          ...
          <?php 
            ...
            // Ambil semua data dan masukkan ke variable $data
              ...
              <tr>
                  ...
                  <td>
                    <a href= "proses/delete-data-pesanan.php?id=<?php echo $value['kode_pesanan']?>"><button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#modalhapus"><i class="bi bi-trash-fill"></i></button></a><br>
                  </td>
              </tr>
              <?php $i++; endforeach; ?>
                          <?php
