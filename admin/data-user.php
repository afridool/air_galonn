          ...
          <?php 
            ...
            // Ambil semua data dan masukkan ke variable $data
              ...
              <tr>
                  ...
                  <td>
                      <a href= "edit-data-user.php?id=<?php echo $value['id_user'] ?>"><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modaledit"><i class="bi bi-pencil-square" name="Edit"></i></button></a><br>
                      <a href= "proses/delete-data-user.php?id=<?php echo $value['id_user']?>"><button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#modalhapus"><i class="bi bi-trash-fill"></i></button></a><br>
                  </td>
              </tr>
              <?php $i++; endforeach; ?>
                          <?php
