  ...
  <div class="w3-row-padding w3-margin-bottom">
    <div class="w3-container">
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
              <a class="nav-link" href="data-pesanan-proses.php" style="color:black;">Sedang Diproses</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="data-pesanan-dikirim.php" style="color:black;">Dikirim</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="data-pesanan-selesai.php" style="color:black;">Selesai</a>
            </li>
        </ul><br>
        <div class="col-sm-10">
        <div class="container" style="background-color: whitesmoke;">
                    ...
                    <?php 
                        ...
                        INNER JOIN depot_galon ON depot_galon.id_galon = pesanan_galon.id_galon
                        WHERE pesanan_galon.status_pesanan = 'Selesai' ORDER BY pesanan_galon.kode_pesanan
                        ");
						// Jalankan perintah SQL
						$query->execute();
						// Ambil semua data dan masukkan ke variable $data
