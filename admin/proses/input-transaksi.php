<?php
 ...
 if(isset($_POST['submit'])){
        ...
        // Jalankan perintah SQL
		 if( $query->execute())
		{
		 echo "<script>alert('Pesanan Berhasil !',document.location.href='../(user) transaksi.php')</script>";
		}
		else
		{
		 echo "<script>alert('Pesanan Gagal !',document.location.href='../(user) checkout.php')</script>";
		}
