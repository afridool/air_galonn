...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="data-depot.php" class="w3-bar-item w3-button w3-padding w3-black" style="text-decoration: none;"><i class="bi bi-building"></i>  Data Depot</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="bi bi-building"></i>  Data Depot</b></h5>
    <hr>
  </header>
  ...
  <div class="w3-row-padding w3-margin-bottom">
    ...
    <table id="myTable" class="table" style="font-size:9pt;">
          ...
          <?php 
              ...
              // Buat prepared statement untuk mengambil semua data dari tbBiodata
            $query = $connect->prepare("SELECT * from depot_galon");
            // Jalankan perintah SQL
            $query->execute();
            // Ambil semua data dan masukkan ke variable $data
              $data = $query->fetchAll();
              ...
              <tr>
                  ...
                  <td>Rp. <?php echo $value['harga_isi_ulang'] ?></td>
                  <td>Rp. <?php echo $value['harga_galon_baru'] ?></td>
                  <td><?php echo $value['alamat_depot'] ?></td>
                  <td><?php echo $value['lokasi_depot'] ?></td>
                  ...
                  <td>
                    <a href= "edit-data-galon.php?id=<?php echo $value['id_galon'] ?>"><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modaledit"><i class="bi bi-pencil-square" name="Edit"></i></button></a><br>
                    <a href= "proses/delete-data-galon.php?id=<?php echo $value['id_galon']?>"><button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#modalhapus"><i class="bi bi-trash-fill"></i></button></a><br>
                  </td>
              </tr>
              <?php $i++; endforeach; ?>
                          <?php
